<?php //Inclusion de archivo de conexion
	...
	else
	{
		...
		if(strcmp($varFoto, "null") == 0 || is_null($varFoto)){
			...
			$consulta = "CALL Update_Producto(" . $varIdProducto . " , '" . $varNombre . "', '" . $varDescripcion . "',
			" . $varIdCategoria . ", " . $varIdProveedor . ", '" . $varCantidadUnidad . "', " . $varUnidadesAlmacen . ", 
			" . $varCantidadMinima . ", " . $varCantidadMaxima . ", null, " . $varEstado . ", " . $varPrecio . ", " . $varIdImpuesto . ", 
			...
			$consulta = "CALL Update_Producto(" . $varIdProducto . " , '" . $varNombre . "', '" . $varDescripcion . "',
			" . $varIdCategoria . ", " . $varIdProveedor . ", '" . $varCantidadUnidad . "', " . $varUnidadesAlmacen . ", 
			" . $varCantidadMinima . ", " . $varCantidadMaxima . ", '" . $varFoto . "', " . $varEstado . ", " . $varPrecio . ", " . $varIdImpuesto . ", 
			" . $varUsuarioActual . ", '" . $varTipoDispositivo . "', '" . $varSistemaOperativo . "');";
